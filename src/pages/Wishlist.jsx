...
function Wishlist() {
  ...
  return (
    <div>
      <Row className='ms-3 ne-3' style={{marginTop:'150px'}}>
     ...
     <Card.Body>
      ...
      <Button onClick={()=>dispatch(removeFromWishlist(item.id))} variant='outline-danger rounded'><i class="fa-solid fa-trash"></i></Button>
        ...
        :<div style={{height:'100vh'}} className='d-flex flex-column justify-content-center align-items-center'>
          <img src="https://cdn.dribbble.com/users/1782212/screenshots/4678452/shopping_cart_abandonment.gif" alt="no image"  height={'300px'}/>
          <h4 className='text-danger mt-3' style={{overflowY:'hidden'}}>Your wishlist is empty</h4>
          <Button className='btn btn-primary rounded mt-3'><Link style={{textDecoration:'none' , color:'white'}} to={'/'}>Back to Home</Link></Button>
        </div>
        }
      </Row>
    </div>
